...
public class VotoController {
    ...
    @PostMapping
    public VotoResponseDTO createVoto(@RequestBody VotoRequestDTO voto) throws Exception {
        return votoService.createVoto(voto);
    }

    @GetMapping("/{id_pauta}")
    public ContagemVotosResponseDTO countVotos(@PathVariable(value = "id_pauta") @NonNull Long idPauta) {
